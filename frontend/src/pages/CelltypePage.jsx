...
export default function CelltypePage() {
    ...
    const handleSubmit = async (event) => {
        ...
        const url = `http://127.0.0.1:8000/api/cell?${queryParams}`;
        ...
        try {
            ...
            fetch(`http://127.0.0.1:8000/api/hpj`)
                .then((res) => res.json())
                .then((results) => {
        ...
        fetch(
            `http://127.0.0.1:8000/gene1/${sliderValues.celltype_name}/${sliderValues.db_type}`
        )
            .then((res) => res.json())
            .then((results) => {
                debugger;
